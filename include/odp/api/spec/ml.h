 ...
 * the implementation capabity of odp_ml_capability_t.max_compl_id. Completion identifier
 ...
 *
 * Application should not try to load concurrently more than configured number of models
